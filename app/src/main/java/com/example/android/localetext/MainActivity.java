...
public class MainActivity extends AppCompatActivity {
    ...
    // Kurs Mata uang indonesia (ID)
    double mIdExchangeRate = 14000; // Rp 14.000 rupiah = $1.

    // TODO: Get locale's currency.
    private NumberFormat mNumberFormat = NumberFormat.getNumberInstance();
    private NumberFormat mCurrentFormat = NumberFormat.getCurrencyInstance();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (deviceLocale.equals("ID")){
            ...
            myFormattedPrice = mCurrentFormat.format(mPrice);
        }else{
            mCurrentFormat = NumberFormat.getCurrencyInstance(Locale.US);
            myFormattedPrice = mCurrentFormat.format(mPrice);
        }
                ...
                if (actionId == EditorInfo.IME_ACTION_DONE) {
                    ...
                    if (v.toString().equals("")) {
                        ...
                        try {
                            ...
                            String myFormattedTotalPrice = mCurrentFormat.format(total);
